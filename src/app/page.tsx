...
export default function Home() {
  ...
  const handleExport = async () => {
    setIsExporting(true);
    const element = document.getElementById("code-editor-container");
    if (!element) {
    ...
    try {
      const canvas = await html2canvas(element, {
        scale: 2,
        backgroundColor: removeBg ? null : outerBackground, // Transparent if removeBg is true
        useCORS: true,
        allowTaint: true,
      });
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const languageToUse =
      language === "auto" ? detectedLanguage || "text" : language;
  ...
  return (
    <div className="min-h-screen text-white flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 font-mono bg-gray-800">
      <Head>
        ...
        <meta
          name="description"
          content="Share code snippets with a single link."
        />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className="max-w-5xl w-full space-y-8 p-6 sm:p-10 rounded-xl bg-gradient-to-br from-gray-800/50 to-gray-900/80 backdrop-blur-sm border transition-all duration-300 shadow-[0_12px_40px_rgba(0,0,0,0.4)] border-gray-600/70">
        <div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex">
            ...
            <div
              className="p-3 rounded-md ml-3 font-mono bg-gray-500 bg-gradient-to-br from-gray-800/50 to-gray-900/80 cursor-pointer"
          ...
          <div
            ...
            style={{ backgroundColor: removeBg ? "transparent" : outerBackground, }}
            id="code-editor-container"
          >
            {/* Code Editor */}
            <div
              className="relative font-mono rounded-lg overflow-hidden"
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <div className="flex items-center gap-4 bg-gray-900/80 border border-gray-700 rounded-full px-4 py-2 shadow-md backdrop-blur-sm">
              {/* Background Picker */}
              ...
              >
                ...
                <div
                  className={`w-10 h-5 flex items-center rounded-full p-1 transition-colors duration-300 ${
                    removeBg ? "bg-green-500" : "bg-gray-600"
                  }`}
                >
                  <div
          ...
          <div className="mt-6">
            <button
              ...
              disabled={loading}
            >
              {loading ? "Creating..." : "Create a shareable Link"}
            </button>
          </div>
        </form>
